const paise = (amount) => Math.max(0, Math.round(amount));
...
export function estimateDistanceKm(pickup, dropoff) {
...
export function computePricing(params) {
    ...
    const ecoSuggestion = params.ecoRideSuggestion && params.vehicleType !== "ELECTRIC"
        ? {
            suggestedVehicle: "ELECTRIC",
